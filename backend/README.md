...
## Project Structure
    ...
    ├── blackmoon_exchange_33237  # Django project configurations
...
1. Clone this repo and `cd blackmoon_exchange_33237`
...
2. Clone this repo and `cd blackmoon_exchange_33237`
